...
public class KlpkDisassemble extends AbstractDisassemble {
	...
	protected List<TicketDTO> doCompound(PrintInterfaceDTO printData, Date createTime) throws Exception {
		...
		KlpkPlayType playType=KlpkPlayType.values()[printData.getBetType()];
		for(String content:contents){
			List<String> resultNewConverList = new ArrayList<String>();
			KlpkCompoundContent compoundContent=JsonUtil.getObject4JsonString(content, KlpkCompoundContent.class);
