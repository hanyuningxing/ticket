...
import com.cai310.lottery.ticket.dataconver.SfzcDataConver;

public class SfzcDisassemble extends AbstractDisassemble {
	...
	protected List<TicketDTO> doCompound(PrintInterfaceDTO printData, Date createTime)
			throws Exception {
		SfzcDataConver sfzcConver = new SfzcDataConver();
		List<TicketDTO> resultList = new ArrayList<TicketDTO>();
		List<TicketDTO> ticketList = sfzcConver.converData(printData, createTime);
