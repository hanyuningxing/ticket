 ...
 * 
 */
public class CombinationUtil<T extends DczcMatchItem> {
	 ...
	 */
	public CombinationUtil(int combinNum, List<T> danCorrectList, List<T> unDanCorrectList, int danMinHit,
			int danMaxHit) {
	...
	private void init() {
		DczcExtensionCombCallBack call = new DczcExtensionCombCallBack();
	...
	class DczcExtensionCombCallBack implements ExtensionCombCallBack {
