 ...
 * 
 */
public class CombinationNumberUtil<T extends String> {
	 ...
	 */
	public CombinationNumberUtil(int combinNum, List<T> danCorrectList, List<T> unDanCorrectList, int danMinHit,
			int danMaxHit) {
	...
	private void init() {
		NumberExtensionCombCallBack call = new NumberExtensionCombCallBack();
	...
	class NumberExtensionCombCallBack implements ExtensionCombCallBack {
