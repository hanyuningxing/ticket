...
public class JclqTicketCombination implements Serializable {
	...
	/** 投注内容 */
	private List<JclqMatchItem> matchItemList;
	 ...
	 */
	public JclqTicketCombination(PlayType playType, List<JclqMatchItem> matchItemList, PassType passType,
	...
	private void forecast() {
		...
		for (JclqMatchItem matchItem : this.matchItemList) {
			...
			for (Item item : playType.getAllItems()) {
				Double award = map.get(item.getValue());
				if (award != null) {
	 ...
	 */
	public List<JclqMatchItem> getMatchItemList() {
	...
	public static Comparator<Double> getAsc() {
		return ASC;
	}

	public static Comparator<Double> getDesc() {
		return DESC;
	}
	...
	public void setMatchItemList(List<JclqMatchItem> matchItemList) {
		this.matchItemList = matchItemList;
	}
