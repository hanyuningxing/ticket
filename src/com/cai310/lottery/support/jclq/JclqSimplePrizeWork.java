...
public class JclqSimplePrizeWork extends JclqPrizeWork {
	private static final long serialVersionUID = 7693392662772828791L;
	...
	public JclqSimplePrizeWork(PassMode passMode, int multiple, PassType passType, List<JcWonMatchItem> correctList) {
