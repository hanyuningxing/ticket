...
public class PrizeForecastDetailItem implements Serializable {
	...
	private final List<List<JczqExtraMatchItem>> detailList;
	...
	public PrizeForecastDetailItem(Integer multiple, Double totalPrize, List<List<JczqExtraMatchItem>> detailList,
			String detail) {
	...
	public List<List<JczqExtraMatchItem>> getDetailList() {
		return detailList;
	}
