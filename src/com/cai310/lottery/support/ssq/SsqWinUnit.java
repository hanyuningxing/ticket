...
@Embeddable
public class SsqWinUnit implements Comparable<SsqWinUnit>, Serializable {
	...
	public int compareTo(SsqWinUnit winUnit2) {
		if (winUnit2 == null)
			return -1;
