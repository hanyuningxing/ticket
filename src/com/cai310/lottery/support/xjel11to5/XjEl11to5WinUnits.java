package com.cai310.lottery.support.xjel11to5;
 ...
 * @version 1.0
 */
public class XjEl11to5WinUnits {
	...
	public List<WinItem> getWinItemList() {
		...
		if (unit != null && unit > 0) {
			list.add(new WinItem(XjEl11to5PlayType.NormalOne.getTypeName(), unit));
		}

		unit = this.getRandomTwoWinUnits();
		if (unit != null && unit > 0) {
			list.add(new WinItem(XjEl11to5PlayType.RandomTwo.getTypeName(), unit));
		}

		unit = this.getForeTwoGroupWinUnits();
		if (unit != null && unit > 0) {
			list.add(new WinItem(XjEl11to5PlayType.ForeTwoGroup.getTypeName(), unit));
		}
		unit = this.getForeTwoDirectWinUnits();
		if (unit != null && unit > 0) {
			list.add(new WinItem(XjEl11to5PlayType.ForeTwoDirect.getTypeName(), unit));
		}
		unit = this.getRandomThreeWinUnits();
		if (unit != null && unit > 0) {
			list.add(new WinItem(XjEl11to5PlayType.RandomThree.getTypeName(), unit));
		}

		unit = this.getForeThreeGroupWinUnits();
		if (unit != null && unit > 0) {
			list.add(new WinItem(XjEl11to5PlayType.ForeThreeGroup.getTypeName(), unit));
		}

		unit = this.getForeThreeDirectWinUnits();
		if (unit != null && unit > 0) {
			list.add(new WinItem(XjEl11to5PlayType.ForeThreeDirect.getTypeName(), unit));
		}

		unit = this.getRandomFourWinUnits();
		if (unit != null && unit > 0) {
			list.add(new WinItem(XjEl11to5PlayType.RandomFour.getTypeName(), unit));
		}

		unit = this.getRandomFiveWinUnits();
		if (unit != null && unit > 0) {
			list.add(new WinItem(XjEl11to5PlayType.RandomFive.getTypeName(), unit));
		}

		unit = this.getRandomSixWinUnits();
		if (unit != null && unit > 0) {
			list.add(new WinItem(XjEl11to5PlayType.RandomSix.getTypeName(), unit));
		}

		unit = this.getRandomSevenWinUnits();
		if (unit != null && unit > 0) {
			list.add(new WinItem(XjEl11to5PlayType.RandomSeven.getTypeName(), unit));
		}

		unit = this.getRandomEightWinUnits();
		if (unit != null && unit > 0) {
			list.add(new WinItem(XjEl11to5PlayType.RandomEight.getTypeName(), unit));
		}
	...
	public String getPrizeDetail() {
		...
		Integer unit = this.getNormalOneWinUnits();
		if (unit != null && unit > 0) {
			prize = XjEl11to5PlayType.NormalOne.getPrize();
			varWonLineText.setVar("PRIZEITEM", XjEl11to5PlayType.NormalOne.getTypeName());
		...
		unit = this.getRandomTwoWinUnits();
		if (unit != null && unit > 0) {
			prize = XjEl11to5PlayType.RandomTwo.getPrize();
			varWonLineText.setVar("PRIZEITEM", XjEl11to5PlayType.RandomTwo.getTypeName());
			varWonLineText.setVar("WINUNITS", unit);
			varWonLineText.setVar("PRIZE", prize >= 10000.0d ? unit * prize * 0.8d : unit * prize);
			prizeDesc += varWonLineText.toString();
		}
		unit = this.getForeTwoGroupWinUnits();
		if (unit != null && unit > 0) {
			prize = XjEl11to5PlayType.ForeTwoGroup.getPrize();
			varWonLineText.setVar("PRIZEITEM", XjEl11to5PlayType.ForeTwoGroup.getTypeName());
			varWonLineText.setVar("WINUNITS", unit);
			varWonLineText.setVar("PRIZE", prize >= 10000.0d ? unit * prize * 0.8d : unit * prize);
			prizeDesc += varWonLineText.toString();
		}
		unit = this.getForeTwoDirectWinUnits();
		if (unit != null && unit > 0) {
			prize = XjEl11to5PlayType.ForeTwoDirect.getPrize();
			varWonLineText.setVar("PRIZEITEM", XjEl11to5PlayType.ForeTwoDirect.getTypeName());
			varWonLineText.setVar("WINUNITS", unit);
			varWonLineText.setVar("PRIZE", prize >= 10000.0d ? unit * prize * 0.8d : unit * prize);
			prizeDesc += varWonLineText.toString();
		}
		unit = this.getRandomThreeWinUnits();
		if (unit != null && unit > 0) {
			prize = XjEl11to5PlayType.RandomThree.getPrize();
			varWonLineText.setVar("PRIZEITEM", XjEl11to5PlayType.RandomThree.getTypeName());
			varWonLineText.setVar("WINUNITS", unit);
			varWonLineText.setVar("PRIZE", prize >= 10000.0d ? unit * prize * 0.8d : unit * prize);
			prizeDesc += varWonLineText.toString();
		}
		unit = this.getForeThreeGroupWinUnits();
		if (unit != null && unit > 0) {
			prize = XjEl11to5PlayType.ForeThreeGroup.getPrize();
			varWonLineText.setVar("PRIZEITEM", XjEl11to5PlayType.ForeThreeGroup.getTypeName());
			varWonLineText.setVar("WINUNITS", unit);
			varWonLineText.setVar("PRIZE", prize >= 10000.0d ? unit * prize * 0.8d : unit * prize);
			prizeDesc += varWonLineText.toString();
		}
		unit = this.getForeThreeDirectWinUnits();
		if (unit != null && unit > 0) {
			prize = XjEl11to5PlayType.ForeThreeDirect.getPrize();
			varWonLineText.setVar("PRIZEITEM", XjEl11to5PlayType.ForeThreeDirect.getTypeName());
			varWonLineText.setVar("WINUNITS", unit);
			varWonLineText.setVar("PRIZE", prize >= 10000.0d ? unit * prize * 0.8d : unit * prize);
			prizeDesc += varWonLineText.toString();
		}
		unit = this.getRandomFourWinUnits();
		if (unit != null && unit > 0) {
			prize = XjEl11to5PlayType.RandomFour.getPrize();
			varWonLineText.setVar("PRIZEITEM", XjEl11to5PlayType.RandomFour.getTypeName());
			varWonLineText.setVar("WINUNITS", unit);
			varWonLineText.setVar("PRIZE", prize >= 10000.0d ? unit * prize * 0.8d : unit * prize);
			prizeDesc += varWonLineText.toString();
		}
		unit = this.getRandomFiveWinUnits();
		if (unit != null && unit > 0) {
			prize = XjEl11to5PlayType.RandomFive.getPrize();
			varWonLineText.setVar("PRIZEITEM", XjEl11to5PlayType.RandomFive.getTypeName());
			varWonLineText.setVar("WINUNITS", unit);
			varWonLineText.setVar("PRIZE", prize >= 10000.0d ? unit * prize * 0.8d : unit * prize);
			prizeDesc += varWonLineText.toString();
		}
		...
		unit = this.getRandomSixWinUnits();
		if (unit != null && unit > 0) {
			prize = XjEl11to5PlayType.RandomSix.getPrize();
			varWonLineText.setVar("PRIZEITEM", XjEl11to5PlayType.RandomSix.getTypeName());
			varWonLineText.setVar("WINUNITS", unit);
			varWonLineText.setVar("PRIZE", prize >= 10000.0d ? unit * prize * 0.8d : unit * prize);
			prizeDesc += varWonLineText.toString();
		}
		...
		unit = this.getRandomSevenWinUnits();
		if (unit != null && unit > 0) {
			prize = XjEl11to5PlayType.RandomSeven.getPrize();
			varWonLineText.setVar("PRIZEITEM", XjEl11to5PlayType.RandomSeven.getTypeName());
			varWonLineText.setVar("WINUNITS", unit);
			varWonLineText.setVar("PRIZE", prize >= 10000.0d ? unit * prize * 0.8d : unit * prize);
			prizeDesc += varWonLineText.toString();
		}
		...
		unit = this.getRandomEightWinUnits();
		if (unit != null && unit > 0) {
			prize = XjEl11to5PlayType.RandomEight.getPrize();
			varWonLineText.setVar("PRIZEITEM", XjEl11to5PlayType.RandomEight.getTypeName());
			varWonLineText.setVar("WINUNITS", unit);
			varWonLineText.setVar("PRIZE", prize >= 10000.0d ? unit * prize * 0.8d : unit * prize);
			prizeDesc += varWonLineText.toString();
		}
	...
	/**
	 * @param normalOneWinUnits
	 *            the normalOneWinUnits to set
	 */
	...
	/**
	 * @param foreTwoGroupWinUnits
	 *            the foreTwoGroupWinUnits to set
	 */
	...
	/**
	 * @param foreTwoDirectWinUnits
	 *            the foreTwoDirectWinUnits to set
	 */
	...
	/**
	 * @param foreThreeGroupWinUnits
	 *            the foreThreeGroupWinUnits to set
	 */
	...
	/**
	 * @param foreThreeDirectWinUnits
	 *            the foreThreeDirectWinUnits to set
	 */
	...
	public void addSdEl11to5WinUnits(XjEl11to5WinUnits winUnit) {
